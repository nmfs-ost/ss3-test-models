...
1943 #_minyr_sdreport:  min year for sdreport outputs (-1 for styr); #_1943
2007 #_maxyr_sdreport:  max year for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2007
0 #_N_STD_yrs:  N individual STD years 
#COND: vector of year values if N>0

0.001 #_converge_criterion: (e.g. 1.0e-04) 
...
-1 #_seed:  random number seed for bootstrap data (-1 to use long(time) as seed): # 1757535720
