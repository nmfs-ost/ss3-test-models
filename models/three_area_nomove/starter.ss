...
three_area_nomove_dat.ss
three_area_nomove_ctl.ss
...
1943 # min year for sdreport outputs (-1 for styr); #_1943
2007 # max year for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2007
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1730740556
