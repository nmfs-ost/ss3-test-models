...
2 # Benchmarks: 0=skip; 1=calc F_spr,F_btgt,F_msy; 2=calc F_spr,F0.1,F_msy; 3=add F_Blimit; 
...
0 # not used
#
2002  # FirstYear for caps and allocations (should be after years with fixed inputs) 
...
2001 # Rebuilder:  year for current age structure (Yinit) (-1 to set to endyear+1)
