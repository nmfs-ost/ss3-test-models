...
6 #_last_estimation_phase:  turn off estimation for parameters entering after this phase
#
0 #_MCMCburn
1 #_MCMCthin
0 # jitter_fraction:  jitter within parameter bounds
1925 #_minyr_sdreport:  min year for sdreport outputs (-1 for styr); #_1925
2008 #_maxyr_sdreport:  max year for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2008
...
3 #_SPR_basis:  0 (skip); 1 (1-SPR)/(1-SPR_tgt); 2 (1-SPR)/(1-SPR_MSY); 3 (1-SPR)/(1-SPR_Btarget); 4 (1-SPR); 5 (SPR)
...
-1 #_seed:  random number seed for bootstrap data (-1 to use long(time) as seed): # 1754323706
