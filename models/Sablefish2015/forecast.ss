...
0.4 # Biomass target (e.g. 0.40) as fraction of SSB_virgin if depletion basis = 1, else as fraction of SSB_unfished in benchmark
...
# 10 1 2012 2014 # selectivity; use:  10 1 2012 2014
# 11 1 2012 2014 # rel_F; use:  11 1 2012 2014
...
0.913 # Buffer:  enter Control rule target as fraction of Flimit (e.g. 0.75), negative value invokes list of [year, scalar]. -year fills from year to YrMax 
