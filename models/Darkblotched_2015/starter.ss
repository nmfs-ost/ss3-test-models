...
darkblotched_data.SS
darkblotched_control.SS
...
1913 # min yr for sdreport outputs (-1 for styr); #_1913
2026 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2026
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1633014429
