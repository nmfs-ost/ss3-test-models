...
2012 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2012
...
4 # Annual_F_units: 0=skip; 1=exploitation(Bio); 2=exploitation(Num); 3=sum(Apical_F's); 4=true F for range of ages; 5=unweighted avg. F for range of ages
 2 24 #_min and max age over which average F will be calculated, with F=Z-M
...
123 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1611957286
