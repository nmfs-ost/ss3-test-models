...
1958 # min year for sdreport outputs (-1 for styr); #_1958
2012 # max year for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2012
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1730739477
