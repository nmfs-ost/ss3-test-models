...
-1 #_minyr_sdreport:  min year for sdreport outputs (-1 for styr); #_1964
-2 #_maxyr_sdreport:  max year for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2020
...
-1 #_seed:  random number seed for bootstrap data (-1 to use long(time) as seed): # 1757601038
